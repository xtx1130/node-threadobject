...
var Thread =  function () {
  ...
  var o = {
    ...
    // ,SignSync: function(message, key){
    //   if(typeof key == 'string') key = new Buffer(key, 'hex');
    //   return thread_.signSync(message, key);
    // },
    // VerifySync: function(message, signature, pubkey){
    //   if(typeof signature == 'string') signature = new Buffer(signature, 'hex');
    //   if(typeof pubkey == 'string') pubkey = new Buffer(pubkey, 'hex');
    //   return thread_.verifySync(message, signature, pubkey);
    // }
  }
